...
public class HOTEL {
  ...
  //Private: Solo se puede acceder al miembro en su propia clase
    ...
    //Realiza la reserva de una habitación si la habitación solicitada está disponible
    ...
    public Reserva reservaHabitacion(String nombre, String cedula, int capacidad, LocalDate fecha) {
        ...
        //Comprobamos si la habitación fue encontrada. En caso afirmativo se procede a realizar la reserva
        if (buscado) {
        ...
        //Si no devuelve un puntero nulo que indica que la reserva no se realizó
        return null;
